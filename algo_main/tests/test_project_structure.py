...
def test_algo_main_does_not_track_generated_data_or_model_artifacts():
    ...
    allowed_report_csvs = {
        ...
        "algo_main/reports/entity_complete_v2_coverage_expansion/18_best_model_runtime_alignment/best_model_artifact_inventory.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/18_best_model_runtime_alignment/feature_parity_matrix.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/18_best_model_runtime_alignment/golden_feature_parity.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/18_best_model_runtime_alignment/golden_result_batch_parity.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/18_best_model_runtime_alignment/golden_score_parity.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/19_formal_algorithm_core_raw_to_batch/full_result_batch_parity.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/19_formal_algorithm_core_raw_to_batch/raw_source_inventory.csv",
        "algo_main/reports/entity_complete_v2_coverage_expansion/19_formal_algorithm_core_raw_to_batch/raw_to_feature_parity.csv",
