"""Build entity-month purchase facts."""
...
def _sum_column(grouped, column: str):
...
def build_fact_entity_month(purchase_events: pd.DataFrame) -> pd.DataFrame:
    """Aggregate purchase events to manufacturer x hospital x drug_group x month."""
