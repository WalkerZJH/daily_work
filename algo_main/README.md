...
第二阶段“终端不丢 / 用户存活”主干算法设计入口：

- 问题定义: `docs/algo/alive_prediction_problem_definition.md`
- Entity 粒度: `docs/algo/entity_grain_research.md`
- 标签定义: `docs/algo/label_definition.md`
- 指标设计: `docs/algo/metric_design.md`
- 数据泄露防护: `docs/algo/data_leakage_guardrails.md`
- 实验计划: `docs/algo/experiment_plan.md`
- Feature view: `configs/features/alive_prediction_feature_view.yaml`
- Metrics config: `configs/metrics/alive_prediction_metrics.yaml`
