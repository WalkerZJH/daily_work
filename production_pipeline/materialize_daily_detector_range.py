...
from .detector_input_snapshot import prepare_detector_orders
from .run_daily_detector import materialize_daily_detector_batch
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(json.dumps({"stage": "daily_detector_range", "status": "completed", "dates": len(results), "status_file": str(status_path).replace("\\", "/")}, ensure_ascii=False))
    return 0
